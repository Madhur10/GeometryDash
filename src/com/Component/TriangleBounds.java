...
public class TriangleBounds extends Bounds{
    ...
    @Override
    public void start(){
        //gameObject.transform.rotation = 45.0f;
        calculateTransform();
    }
    ...
    private boolean boxIntersectingLine(Vector2 p1, Vector2 p2, int depth, BoxBounds bounds, Vector2 position){
        ...
        // Check if the line is completely inside, or outside, or half in or half out
        if (code1 == 0 && code2 == 0){
    ...
    public void draw(Graphics2D g2){
        if (isSelected) {
            ...
            g2.draw(new Line2D.Float(this.x1 - Window.getScene().camera.position.x,
            ...
            g2.draw(new Line2D.Float(this.x3 - Window.getScene().camera.position.x,
                    this.y3 - Window.getScene().camera.position.y,
                    this.x2 - Window.getScene().camera.position.x,
                    this.y2 - Window.getScene().camera.position.y));
